...
sT[0].sCP[0].sCPR[203].nDCStart=1028;   sT[0].sCP[0].sCPR[203].nDCNum= 4;    sT[0].sCP[0].sCPR[203].nSCStart=1032;   sT[0].sCP[0].sCPR[203].nAckStart =0;	  sT[0].sCP[0].sCPR[203].nAckNum=0;   sT[0].sCP[0].sCPR[203].nSPOffsetCS= 4838; sT[0].sCP[0].sCPR[203].nSPOffsetLek= 4839;
...
sT[0].sTI[14].nType = TYP_TMOK;
	...
	sT[0].sMOT[14].nIEC_NM				= 1458;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[25].nType = TYP_TMOK;
	...
	sT[0].sMOT[25].nIEC_NM				= 1454;		/* Mérések IEC kezdõcíme */	
...
/* Gyõr, Ipari park tr. állomás  ----------------------------------------------------------------*/
sT[0].sTI[147].nType = TYP_MOT;

	sT[0].sMOT[147].nIEC_SP				= 3254;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[147].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[147].nIEC_DP				= 912;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[147].nIEC_DP_NUM			= 2;   		/* Két bites értékek száma*/
	sT[0].sMOT[147].nIEC_NM				= 0;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[147].nNMNum				= 0;		/* Analóg mérések száma*/

/* Fertõd 072/14,15,16,19,20 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[148].nType = TYP_MOT;

	sT[0].sMOT[148].nIEC_SP				= 3272;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[148].nIEC_SP_NUM			= 32;		/* Egybites értékek száma*/
	sT[0].sMOT[148].nIEC_DP				= 914;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[148].nIEC_DP_NUM			= 32;   		/* Két bites értékek száma*/
...
sT[0].sTI[151].nType = TYP_TMOK;
	...
	sT[0].sMOT[151].nIEC_SP				= 3322;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[151].nIEC_DP				= 947;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[151].nIEC_NM				= 1033;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[151].nNMNum				  = 4;		/* Analóg mérések száma*/

  /* Tapolca 0350/11-16 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[152].nType = TYP_MOT;

	sT[0].sMOT[152].nIEC_SP				= 3338;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[152].nIEC_SP_NUM			= 48;		/* Egybites értékek száma*/
	sT[0].sMOT[152].nIEC_DP				= 948;		/* Kétbites értékek IEC kezdõcíme*/
...
sT[0].sTI[155].nType = TYP_MOT;
	...
	sT[0].sMOT[155].nIEC_SP_NUM			= 88;		/* Egybites értékek száma*/
...
/* Tapolca 0350/34-37 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[161].nType = TYP_MOT;

	sT[0].sMOT[161].nIEC_SP				= 3682;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[161].nIEC_SP_NUM			= 56;		/* Egybites értékek száma*/
	sT[0].sMOT[161].nIEC_DP				= 1048;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[161].nIEC_DP_NUM			= 18;   		/* Két bites értékek száma*/
	sT[0].sMOT[161].nIEC_NM				= 1136;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[161].nNMNum				= 24;		/* Analóg mérések száma*/

/* Kesztölc 3733 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[162].nType = TYP_MOT;

	sT[0].sMOT[162].nIEC_SP				= 3740;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[162].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[162].nIEC_DP				= 1066;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[162].nIEC_DP_NUM			= 8;   		/* Két bites értékek száma*/
	sT[0].sMOT[162].nIEC_NM				= 1160;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[162].nNMNum				= 9;		/* Analóg mérések száma*/

/* 54-27  ----------------------------------------------------------------*/
sT[0].sTI[163].nType = TYP_TMOK;

	sT[0].sMOT[163].nIEC_SP				= 3758;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[163].nIEC_DP				= 1074;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[163].nIEC_NM				= 1169;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[163].nNMNum				  = 4;		/* Analóg mérések száma*/

/* Nagyhideghegy ISM -----------------------------------------------------------*/
sT[0].sTI[164].nType = TYP_MOT;

	sT[0].sMOT[164].nIEC_SP				  = 3774;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[164].nIEC_SP_NUM			= 5;		/* Egybites értékek száma*/
	sT[0].sMOT[164].nIEC_DP_NUM			= 0;
	sT[0].sMOT[164].nNMNum      		= 0;

/* Hidegkút 07/22_23 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[165].nType = TYP_MOT;

	sT[0].sMOT[165].nIEC_SP				= 3781;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[165].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[165].nIEC_DP				= 1075;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[165].nIEC_DP_NUM			= 8;   		/* Két bites értékek száma*/
	sT[0].sMOT[165].nIEC_NM				= 1173;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[165].nNMNum				= 9;		/* Analóg mérések száma*/

/* Gyõr, Édász belterület  -----------------------------------------------------------*/
...
sT[0].sTI[168].nType = TYP_TMOK;
	...
	sT[0].sMOT[168].nIEC_SP				= 3875;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[168].nIEC_DP				= 1103;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[168].nIEC_NM				= 1195;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[168].nNMNum				  = 4;		/* Analóg mérések száma*/

/* 12-81  ----------------------------------------------------------------*/
sT[0].sTI[169].nType = TYP_TMOK;

	sT[0].sMOT[169].nIEC_SP				= 3891;		/* Egybites értékek IEC kezdõcíme*/
...
/* Veszprémvarsány 67/1_2_3 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[174].nType = TYP_MOT;

	sT[0].sMOT[174].nIEC_SP				= 4046;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[174].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[174].nIEC_DP				= 1137;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[174].nIEC_DP_NUM			= 8;   		/* Két bites értékek száma*/
	sT[0].sMOT[174].nIEC_NM				= 1239;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[174].nNMNum				= 9;		/* Analóg mérések száma*/

/* Türje 0135/15 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[175].nType = TYP_MOT;

	sT[0].sMOT[175].nIEC_SP				= 4064;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[175].nIEC_SP_NUM			= 28;		/* Egybites értékek száma*/
	sT[0].sMOT[175].nIEC_DP				= 1145;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[175].nIEC_DP_NUM			= 16;   		/* Két bites értékek száma*/
	sT[0].sMOT[175].nIEC_NM				= 1248;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[175].nNMNum				= 18;		/* Analóg mérések száma*/

/* Rádóckölked 258 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[176].nType = TYP_MOT;

	sT[0].sMOT[176].nIEC_SP				= 4094;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[176].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[176].nIEC_DP				= 1161;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[176].nIEC_DP_NUM			= 4;   		/* Két bites értékek száma*/
	sT[0].sMOT[176].nIEC_NM				= 1266;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[176].nNMNum				= 9;		/* Analóg mérések száma*/

/* Szentkirályszabadja 056/1 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[177].nType = TYP_MOT;

	sT[0].sMOT[177].nIEC_SP				= 4112;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[177].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[177].nIEC_DP				= 1165;		/* Kétbites értékek IEC kezdõcíme*/
...
/* Bicske 071/2 PV erõmû  ----------------------------------------------------------------*/
sT[0].sTI[179].nType = TYP_MOT;

	sT[0].sMOT[179].nIEC_SP				= 4164;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[179].nIEC_SP_NUM			= 48;		/* Egybites értékek száma*/
	sT[0].sMOT[179].nIEC_DP				= 1191;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[179].nIEC_DP_NUM			= 34;   		/* Két bites értékek száma*/
	sT[0].sMOT[179].nIEC_NM				= 1312;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[179].nNMNum				= 43;		/* Analóg mérések száma*/

/* Nemesgulács TMOK  ----------------------------------------------------------------*/
sT[0].sTI[180].nType = TYP_TMOK;

	sT[0].sMOT[180].nIEC_SP				= 4214;		/* Egybites értékek IEC kezdõcíme*/
...
sT[0].sTI[184].nType = TYP_MOT;
	...
	sT[0].sMOT[184].nIEC_SP				= 4347;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[184].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[184].nIEC_DP				= 1500;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[184].nIEC_DP_NUM			= 4;   		/* Két bites értékek száma*/
	sT[0].sMOT[184].nIEC_NM				= 1386;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[184].nNMNum				= 9;		/* Analóg mérések száma*/

/* Szany 0155/6 PV erõmû ----------------------------------------------*/
...
sT[0].sTI[189].nType = TYP_MOT;
	...
	sT[0].sMOT[189].nIEC_SP				= 4495;		/* Egybites értékek IEC kezdõcíme*/
...
sT[0].sTI[193].nType = TYP_TMOK;
	...
	sT[0].sMOT[193].nIEC_SP				= 4545;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[193].nIEC_DP				= 1541;		/* Kétbites értékek IEC kezdõcíme*/
...
sT[0].sTI[195].nType = TYP_MOT;
	...
	sT[0].sMOT[195].nIEC_SP				= 0;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[195].nIEC_SP_NUM			= 0;		/* Egybites értékek száma*/
	sT[0].sMOT[195].nNMNum      		= 0;
	sT[0].sMOT[195].nIEC_DP_NUM			= 0;   		/* Két bites értékek száma*/

/* 41-35 TMOK  ----------------------------------------------------------------*/
sT[0].sTI[196].nType = TYP_TMOK;

	sT[0].sMOT[196].nIEC_SP				= 4585;		/* Egybites értékek IEC kezdõcíme*/
...
/* Bicske 074 PV erõmû -----------------------------------------------------------*/
sT[0].sTI[201].nType = TYP_MOT;

	sT[0].sMOT[201].nIEC_SP				= 4753;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[201].nIEC_SP_NUM			= 17;		/* Egybites értékek száma*/
	sT[0].sMOT[201].nIEC_DP				= 1657;		/* Kétbites értékek IEC kezdõcíme*/
...
/* Nemesrempehollós 259/7 07/4 PV erõmû -----------------------------------------------------------*/
sT[0].sTI[203].nType = TYP_MOT;

	sT[0].sMOT[203].nIEC_SP				= 4822;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[203].nIEC_SP_NUM			= 16;		/* Egybites értékek száma*/
	sT[0].sMOT[203].nIEC_DP				= 1741;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[203].nIEC_DP_NUM			=4;   		/* Két bites értékek száma*/
	sT[0].sMOT[203].nIEC_NM				= 1539;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[203].nNMNum				= 9;		/* Analóg mérések száma*/
